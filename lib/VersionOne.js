(function () {
    ...
    module.exports = {
        ...
        VersionOne: VersionOne = (function () {
            ...
            /**
             * Initialise the VersioneOne instance (load statuses)
             */
            VersionOne.prototype.init = function() {
                this.getStatuses({
            ...
            VersionOne.prototype.buildUrl = function (query) {
                var url = this.protocol + '://' + this.hostname + ':' + this.port + '/' +
                    this.instance + '/rest-1.v1/Data/' + query.from + '?' + this.buildSelectClause(query.select) + '&' + this.buildWhereClause(query.where) + '&sort=' + query.sort + '&accept=text/json';
                return url;
            };
